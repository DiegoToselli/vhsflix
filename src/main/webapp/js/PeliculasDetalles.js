document.addEventListener("DOMContentLoaded", function () {
    ...
    btnModificarElement.addEventListener("click",function () {
        ...
        PeliculaDetallesContainer.innerHTML= `<div class="col-md-6 text-center">
                      <div class="clearfix">
                        <img src="data:image/jpeg;base64,${objetoPelicula.portada}" class="my-4" style="width: 75%;" alt="imagen de pelicula"/>
                      </div>
                    </div>
 <div class="container mt-3">
            <form class="mb-4" id="addPeliculaForm" enctype="multipart/form-data">
                <div class="container">
                    <div class="row">
    ...
    btnGuardarElement.addEventListener("click",function (e) {
        ...
        form.append("imagen",objetoPelicula.portada);
        fetch(`/app/peliculas`,{
            method:"POST",
            body:form
